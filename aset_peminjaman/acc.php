...
<!--sidebar-->
    ...
    <div class="divider"></div>
        <ul class="nav menu">
            ...
            <li><a class="active" href="acc.php">
            <span class="fa fa-arrow-right">&nbsp;</span> Approved Data Request
            </a></li>
   ...
   <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Approved Procurement of Items</li>
            </ol>
        </div><!--/.row-->
...
?>
              <table id="example1" class="table table-bordered table-hover table-condensed">
                ...
                <th>TTD Manajer Akuntansi</th>
                <th>TTD Manajer Umum</th>
        ...
        <?php
            ...
            $result=mysqli_query($connection, "SELECT tbpengadaan.koder, tbpengadaan.NIK, tbpengadaan.nama_aset, tbpengadaan.kelompok_aset, tbpengadaan.posisi, tbpengadaan.tujuan, tbpengadaan.stock1, tbpengadaan.harga, tbpengadaan.tgl_pengajuan, tbpengadaan.keteranganakun, tbpengadaan.keterangan 
                FROM tbpengadaan
                WHERE  status = 'Approved' and tbpengadaan.NIK = '$nik'");
