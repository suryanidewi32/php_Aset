...
<!--sidebar-->
   <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
          ...
          <li class="active"><a href="buy.php"><em class="fa   fa-history ">&nbsp;</em> History of Purchase</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">History of Purchase</li>
			</ol>
		</div><!--/.row-->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> List of New Assets</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
		...
		<?php
			...
			$result=mysqli_query($connection, "SELECT * FROM tbpengadaan
                WHERE status='Approved' and statusbarang in ('beli','Tersedia') ");
