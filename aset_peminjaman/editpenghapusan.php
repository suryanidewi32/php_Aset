...
include('connection.php');
    ...
    $result=mysqli_query($connection, "select * from tbpenghapusan WHERE kode_aset='$kode_aset'");
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Form Edit Asset Deletion </li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-md-9">
				...
				<div class="panel-heading">
						Form Edit Asset Deletion
						<span class="pull-right clickable panel-toggle panel-button-tab-left"><em class="fa fa-toggle-up"></em></span></div>
					<div class="panel-body">
        <?php 
        $kode_aset=$_GET['kode_aset'];
        ?>
		  <form class="form-horizontal" action='proses/proseseditpenghapusan.php' autocomplete="off" method='POST' enctype="multipart/form-data" onsubmit="return validasi_input(this)">
        <fieldset>
            ...
            <option value="Lelang" <?php if($data['metode_penghapusan']=='Lelang'){echo "selected";}?>> Lelang</option>
            <option value="Renovasi" <?php if($data['metode_penghapusan']=='Renovasi'){echo "selected";}?>> Renovasi</option>
             <option value="Dijual" <?php if($data['metode_penghapusan']=='Dijual'){echo "selected";}?>> Dijual</option>
                    </select>
      ...
      <label class="col-md-3 control-label" for="nilai_residu">Nilai Residu</label>
            <div class="col-md-9">
            <input type="text" id="nilai_residu" value="<?php echo $data['nilai_residu']?>" name="nilai_residu" placeholder="Nilai Residu"  class="form-control" onkeypress="return hanyaAngka(event)" minlength="1" maxlength="10">
            </div>
            </div>
      ...
      <label class="col-md-3 control-label" for="nama_penerima">Nama Penerima*</label>
            <div class="col-md-9">
            <input type="text" id="nama_penerima" value="<?php echo $data['nama_penerima']?>" name="nama_penerima" placeholder="Nilai Penerima"  class="form-control" minlength="1" maxlength="30">
            </div>
            </div>
      ...
      <label class="col-md-3 control-label" for="tgl_penghapusan">Tanggal Penghapusan</label>
            ...
            <div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
                  <input class="form-control" value="<?php echo $data['tgl_penghapusan']?>" type="text" id="tgl_penghapusan" name="tgl_penghapusan" readonly="readonly">
