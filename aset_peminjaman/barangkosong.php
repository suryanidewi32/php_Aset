	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Form Pembatalan Pembelian Aset Baru</li>
			</ol>
		</div><!--/.row-->
			...
			<div class="col-md-9">
				...
				<div class="panel-heading">
					...
					<div class="panel-body">
                        ...
                        $koder=$_GET['koder'];
        ?>
		  <form class="form-horizontal" action='proses/prosesbatal.php' method='POST' enctype="multipart/form-data" onsubmit="return validasi_input(this)">
        <fieldset>
            ...
            <div class="col-md-9">
            <input type="text" id="koder" name="koder" value="<?=$koder ?>" class="form-control" readonly>
            </div>
            </div>
            ...
            <option value="pilih" selected>-- Pilih Kosong --</option>
          ...
          <br>
            			 <div class="controls">
              <button class="btn btn-primary  btn-md pull-right" name="simpan">Pembatalan</button>
            </div>
          </div>  
							</fieldset>
						</form>
