...
<!--Tutup Header-->
         ...
         <ul class="nav menu">
            ...
            <li class=" parent"><a data-toggle="collapse" href="#sub-item-1">
                ...
                <ul class="children collapse" id="sub-item-1">
                    <li><a class="active" href="newbarang.php">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-md-9">
             ...
             <?php 
                        $kode_aset=$_GET['kode_aset'];
        ?>
		  <form class="form-horizontal" action='proses/prosestambahbarang.php' autocomplete="off" method='POST' enctype="multipart/form-data" onsubmit="return validasi_input(this)">
        <fieldset>
      ...
      <div class="form-group">
            <label class="col-md-3 control-label" for="nama_aset">Nam Aset*</label>
            <div class="col-md-9">
            ...
            <div class="form-group">
            <label class="col-md-3 control-label" for="jns">Jenis Barang*</label>
            <div class="col-md-9">
            <select name="jns" class="form-control">
            <option value="pilih" selected>-- Pilih Jenis Barang --</option>
            ...
            <div class="col-md-9">
            <input type="text" id="merk" name="merk" value="<?php echo $data1['merk']?>" placeholder="Merk" class="form-control" minlength="1" maxlength="20" readonly>
            </div>
          	</div>
            ...
            <div class="col-md-9">
            <input type="text" id="posisi" name="posisi" placeholder="Letak Barang" value="<?php echo $data1['posisi']?>" class="form-control" minlength="1" maxlength="20" readonly>
            </div>
            </div>
