...
?></li>
     ...
     $where = "where tgl_beli>='".$startdate."'and tgl_beli<='".$enddate."'";
    ...
    <br>
    <br>
     <a class="btn btn-default btn-sm" data-toggle="modal" data-target="#cetakpdf"><i class=" fa fa-print"></i> Print by Year</a>
