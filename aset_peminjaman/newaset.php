        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> New Asset Data</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
      ...
      $no=1;
        ...
        echo "    
          ...
          <td>".$data['harga']."</td>
                    ...
                    <td>
                    <a href='tambahaset.php?koder=$data[koder]'>
                    <button class='btn btn-outline-info btn-sm btn-success' data-toggle='tooltip' title='New Asset Data'>
