...
<!--sidebar-->
    ...
    <div class="divider"></div>
        <ul class="nav menu">
            ...
            <li><a class="active" href="unapproved.php">
            <span class="fa fa-arrow-right">&nbsp;</span> Unapproved Data Request
            </a></li>
            </ul>
   ...
   <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Unapproved Procurement of Items</li>
            </ol>
        </div><!--/.row-->
...
?>
        ...
        <?php
            ...
            $result=mysqli_query($connection, "SELECT tbpengadaan.koder, tbpengadaan.NIK, tbpengadaan.nama_aset, tbpengadaan.kelompok_aset, tbpengadaan.posisi, tbpengadaan.tujuan, tbpengadaan.stock1, tbpengadaan.harga, tbpengadaan.tgl_pengajuan, tbpengadaan.keterangan 
                FROM tbpengadaan
                WHERE  status = 'Tidak' and tbpengadaan.NIK = '$nik' ");
