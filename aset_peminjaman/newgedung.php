...
<!--Tutup Header-->
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> List of Building</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
        ...
        <?php
            ...
            $result=mysqli_query($connection, "SELECT tbpengadaan.merk,tbpengadaan.posisi,tbaset.nama_aset,tbaset.kelompok_aset , tbaset.kode_aset
            FROM  tbaset 
            INNER JOIN tbpengadaan ON tbpengadaan.kode_aset = tbaset.kode_aset
                WHERE tbaset.kelompok_aset = 'Gedung' and tbaset.status='' ");
            ...
            $no=1;
                ...
                echo "    
                    ...
                    <td>
                    <a href='tambahgedung.php?kode_aset=$data[kode_aset]'>
                    <button class='btn btn-outline-info btn-sm btn-success' data-toggle='tooltip' title='add inventory'>
