            ...
            <li class=""><a href="index.php"><em class="fa fa-dashboard">&nbsp;</em> Dashboard</a></li>
             <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
                ...
                <ul class="children collapse" id="sub-item-1">
                    <li><a class="active" href="aset.php">
      ...
      <div class="col-lg-12">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
  <a class="btn btn-default btn-sm" data-toggle="modal" data-target="#tampil"><i class=" fa fa-print"></i> Select Fixed Asset by Year</a>
   <?php
        include "modaltampilaset.php";
        ?>
...
<script type="text/javascript">
    ...
    function tampil(){
      ...
      var urlcetak = "/aset_peminjaman/aset.php?tgl_a="+tgl_a+"&tgl_b="+tgl_b;
