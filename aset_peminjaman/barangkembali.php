	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Form Return Loan Of Items </li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-md-9">
				...
				<div class="panel-heading">
						Form Return Loan Of Items
						<span class="pull-right clickable panel-toggle panel-button-tab-left"><em class="fa fa-toggle-up"></em></span></div>
					<div class="panel-body">
                        <?php 
                        $kodep=$_GET['kodep'];
        ?>
		  <form class="form-horizontal" action='proses/proseskembalipeminjaman.php' method='POST' enctype="multipart/form-data" onsubmit="return validasi_input(this)">
        <fieldset>
            ...
            <div class="col-md-9">
             ...
             <div class="form-group">
            <label class="col-md-3 control-label" for="statuspeminjaman">Pilih Kembali*</label>
            <div class="col-md-9">
            <select name="statuspeminjaman" class="form-control">
            <option value="pilih" selected>-- Pilih Kembali --</option>
          ...
          <br>
            			 <div class="controls">
              <button class="btn btn-primary  btn-md pull-right" name="simpan">Simpan</button>
            </div>
          </div>  
							</fieldset>
						</form>
