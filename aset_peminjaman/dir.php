        ...
        <ul class="nav menu">
            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
                ...
                <ul class="children collapse" id="sub-item-2">
                    ...
                    <li><a class="active" href="dir.php">
   ...
   <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">List Inventory Report</li>
            </ol>
        </div><!--/.row-->
        ...
        <?php
            ...
            $result=mysqli_query($connection, "SELECT tbgedung.kode_aset, tbaset.nama_aset, tbaset.kelompok_aset, tbgedung.luas_gedung,tbgedung.posisi
                FROM tbgedung
                INNER JOIN tbaset ON tbaset.kode_aset = tbgedung.kode_aset  
                WHERE tbaset.kelompok_aset in ('Barang', 'Elektronik')
                ");
        ...
        <?php
            ...
            $result=mysqli_query($connection, "SELECT daftarinventaris.kode_aset, tbaset.kelompok_aset, daftarinventaris.jns, tbaset.nama_aset, daftarinventaris.merk, tbaset.stock1, daftarinventaris.posisi
        ...
        <?php
            ...
            $result=mysqli_query($connection, "SELECT tbkendaraan.kode_aset, tbaset.kelompok_aset, tbkendaraan.jns, tbaset.nama_aset, tbkendaraan.merk, tbkendaraan.no_kendaraan, tbkendaraan.thn_pembuatan, tbkendaraan.no_rangka, tbkendaraan.no_mesin, tbkendaraan.posisi
                FROM tbkendaraan
        ...
        ?>
            ...
            <!-- /.box-header -->
                ...
                <a href="cetakdir.php" target="_blank"><button class="btn btn-default btn-xs"><i class="fa fa-print"></i>cetak</button></a>
