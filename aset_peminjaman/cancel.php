        ...
        <ul class="nav menu">
           ...
           <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
                ...
                <ul class="children collapse" id="sub-item-2">
                    ...
                    <li><a class="active" href="cancel.php">
   ...
   <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Unapproved Data Request</li>
            </ol>
        </div><!--/.row-->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> Unpproved</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                 <?php
...
?>
        ...
        <?php
            ...
            $result=mysqli_query($connection, "SELECT tbpeminjaman.NIK, tbpeminjaman.kode_aset, tbaset.nama_aset, tbaset.kondisi_aset, tbpeminjaman.kegiatan, tbpeminjaman.jumlah_pesanan, tbpeminjaman.tgl_peminjaman, tbpeminjaman.tgl_pengembalian, tbpeminjaman.keterangan, tbpeminjaman.keteranganmanajer
                FROM tbpeminjaman
                INNER JOIN tbaset ON tbaset.kode_aset = tbpeminjaman.kode_aset 
                WHERE  keterangan in ('Tidak di Setujui') and tbpeminjaman.NIK = '$nik'");
