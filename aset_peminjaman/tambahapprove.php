  ...
  <link rel="stylesheet" href="dist/css/skins/_all-skins.min.css">
	...
	<script type="text/javascript">
      ...
      if (form.statuspeminjaman.value == "pilih"){
        ...
        if (form.namapetugas.value == ""){
          alert("Nama Petugas harus diisi!");
          form.namapetugas.focus();
          return (false);
        }

        if (form.namapetugas.value.length < mincar){
          alert("Panjang Nama Minimal 5 Karakter!");
          form.namapetugas.focus();
          return (false);
        }

         if (form.ttdpetugas.value == ""){
          alert("TTD Petugas harus diisi!");
          form.ttdpetugas.focus();
            return (false);
        }
                ...
                <em class="fa fa-edit">&nbsp;</em> New Data <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"><em class="fa fa-plus"></em></span>
                 ...
                 <ul class="children collapse" id="sub-item-1">
                    ...
                    <li><a class="" href="newgedung.php">
                        <span class="fa fa-arrow-right">&nbsp;</span> NNew Building
                    </a></li>
                </ul>
            </li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Loan Verification </li>
			</ol>
		</div><!--/.row-->
			...
			<div class="col-md-9">
				...
				<div class="panel-heading">
					...
					<div class="panel-body">
                        ...
                        $kodep=$_GET['kodep'];
        ?>
		  <form class="form-horizontal" action='proses/prosesapproval.php' method='POST' enctype="multipart/form-data" onsubmit="return validasi_input(this)">
        <fieldset>
            ...
            <div class="form-group">
            <label class="col-md-3 control-label" for="namapetugas">Masukkan Nama Anda*</label>
            <div class="col-md-9">
            <input type="text" id="namapetugas" name="namapetugas" class="form-control" minlength="5" maxlength="30">
            </div>
            </div>
           
            <div class="form-group">
              <label class="col-md-3 control-label" for="ttdpetugas" >TTD Anda*</label>
              <div class="col-md-9">
                <input  type="file" name="ttdpetugas">
              </div>
            </div>
