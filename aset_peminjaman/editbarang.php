...
include('connection.php');
    ...
    $result=mysqli_query($connection, "select * from daftarinventaris WHERE kode_aset='$kode_aset'");
            ...
            <li class=" parent"><a data-toggle="collapse" href="#sub-item-1">
             ...
             <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
                ...
                <ul class="children collapse" id="sub-item-2">
                    <li><a class="active" href="barang.php">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Form Edit Items</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
		  ...
		  <form class="form-horizontal" action='proses/proseseditbarang.php' method='POST' enctype="multipart/form-data" onsubmit="return validasi_input(this)">
        <fieldset>
       ...
       <div class="form-group">
            ...
            <option value="DSLR" <?php if($data['jns']=='DSLR'){echo "selected";}?>> DSLR</option>
            <option value="Handycam" <?php if($data['jns']=='Handycam'){echo "selected";}?>> Handycam</option> 
             <option value="Laptop" <?php if($data['jns']=='Laptop'){echo "selected";}?>> Laptop</option> 
           <option value="Komputer" <?php if($data['jns']=='Komputer'){echo "selected";}?>> Komputer</option> 
            </select>
...
<div class="form-group">
            ...
            <div class="col-md-9">
            <input type="text" id="merk" value="<?php echo $data['merk']?>" name="merk" placeholder="Merk" class="form-control" minlength="1" maxlength="20">
            </div>
            </div>
            ...
            <div class="col-md-9">
            <input type="text" id="posisi" value="<?php echo $data['posisi']?>" name="posisi" placeholder="Posisi Barang" class="form-control" minlength="1" maxlength="20">
            </div>
            </div>
