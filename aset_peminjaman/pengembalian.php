   ...
   <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
           ...
           <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
            ...
            <li class="active"><a href="pengembalian.php"><em class="fa  fa-rotate-right">&nbsp;</em>Return of Items</a></li>
   ...
   <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li class="active">Return Loan Of Items </li>
            </ol>
        </div><!--/.row-->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> Sudah di Kembalikan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                 <?php
...
?>
        ...
        <?php
            ...
            $result=mysqli_query($connection, "SELECT tbpeminjaman.kodep,tbpeminjaman.NIK, tbpeminjaman.kode_aset, tbaset.nama_aset, tbaset.kondisi_aset, tbpeminjaman.kegiatan, tbpeminjaman.jumlah_pesanan, tbpeminjaman.tgl_peminjaman, tbpeminjaman.tgl_pengembalian, tbpeminjaman.statuspeminjaman
                FROM tbpeminjaman
                INNER JOIN tbaset ON tbaset.kode_aset = tbpeminjaman.kode_aset 
                WHERE  statuspeminjaman in ('Kembali') and tbpeminjaman.NIK = '$nik'");
