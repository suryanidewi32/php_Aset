         ...
         <ul class="nav menu">
            ...
            <li class=" parent"><a data-toggle="collapse" href="#sub-item-1">
                ...
                <ul class="children collapse" id="sub-item-1">
                    ...
                    <li><a class="active" href="newgedung.php">
    ...
    <div class="row">
        ...
        <div class="panel-heading">
          ...
          <div class="panel-body">
             <?php 
                        $kode_aset=$_GET['kode_aset'];
        ?>
      <form class="form-horizontal" action='proses/prosestambahgedung.php' autocomplete="off" method='POST' enctype="multipart/form-data" onsubmit="return validasi_input(this)">
        <fieldset>
      ...
      <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-9">
            <input type="text" id="luas_gedung" name="luas_gedung" placeholder="Luas" class="form-control" minlength="1" maxlength="10">
            </div>
            </div>
            ...
            <div class="col-md-9">
            <input type="text" id="posisi" name="posisi" value="<?php echo $data1['posisi']?>" placeholder="Posisi" class="form-control" minlength="1" maxlength="20" readonly>
            </div>
            </div>
