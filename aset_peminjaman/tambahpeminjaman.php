...
$result = mysqli_query($con, "SELECT kodep FROM tbpeminjaman ORDER BY kodep DESC");
...
<head>
  ...
  <link rel="stylesheet" href="dist/css/skins/_all-skins.min.css">
	...
	<script type="text/javascript">
	  ...
	  if (form.tgl_pengembalian.value == ""){
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Form Loan of Items </li>
			</ol>
		</div><!--/.row-->
        ...
        ?>
		  <form class="form-horizontal" action='proses/prosespeminjaman.php' autocomplete="off" method='POST' enctype="multipart/form-data" onsubmit="return validasi_input(this)">
        <fieldset>

          <div class="form-group">
            <label class="col-md-3 control-label" for="kodep">Kode Peminjaman*</label>
            <div class="col-md-9">
            <input type="text" id="kodep" name="kodep"
            ...
            <div class="col-md-9">
            <input type="text" id="NIK" name="NIK" placeholder="NIK" value="<?=$nik ?>" class="form-control" readonly>
            </div>
			</div>
            ...
            <div class="col-md-9">
            <input type="text" id="kegiatan" name="kegiatan" placeholder="kegiatan" class="form-control" minlength="5" maxlength="30">
            </div>
            </div>
            ...
            <div class="col-md-9">
            <input type="text" id="lokasi_kegiatan" name="lokasi_kegiatan" placeholder="Lokasi Kegiatan" class="form-control" minlength="5" maxlength="30">
            </div>
            </div>
            ...
            <div class="col-md-9">
            <input type="number" min="1" id="jumlah_pesanan" name="jumlah_pesanan" placeholder="Jumlah Pesanan" class="form-control" onkeypress="return hanyaAngka(event)" minlength="1" maxlength="5">
            </div>
            </div>
            ...
            <div class="col-md-9">
                    ...
                    <input class="form-control" type="text" id="tgl_peminjaman" name="tgl_peminjaman" readonly="readonly">
            ...
            <div class="col-md-9">
                    <div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
                    <input class="form-control" type="text" id="tgl_pengembalian" name="tgl_pengembalian" readonly="readonly">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
            </div>
            </div> </div>
            ...
            <option value="pilih" selected>-- Pilih Menunggu --</option>
          ...
          <br>
            			 <div class="controls">
              <button class="btn btn-primary  btn-md pull-right" name="simpan">Tambahkan</button>
            </div>
             </div>  
          Catatan : <br>
          1. Barang yang Sudah di Setujui Akan Tampil Pada Dashboard<br>
          2. Jika Barang Tidak di Setujui Akan Tampil Pada History Unapproved
