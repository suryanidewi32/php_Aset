...
$kode_aset=$_GET['kode_aset'];
    ...
    $data = mysqli_fetch_array($result);
     ...
     $result1=mysqli_query($connection, "select * from tbpengadaan WHERE kode_aset='$kode_aset'");
...
<!--Tutup Header-->
         ...
         <ul class="nav menu">
            ...
            <li class=" parent"><a data-toggle="collapse" href="#sub-item-1">
                ...
                <ul class="children collapse" id="sub-item-1">
                    ...
                    <li><a class="active" href="newkendaraan.php">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Form Inventory</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
            ...
            <?php 
                        $kode_aset=$_GET['kode_aset'];
        ?>
		  <form class="form-horizontal" action='proses/prosestambahkendaraan.php' autocomplete="off" method='POST' enctype="multipart/form-data" onsubmit="return validasi_input(this)">
        <fieldset>
        ...
        <div class="form-group">
        	...
        	<div class="form-group">
			<label class="col-md-3 control-label" for="jns">Jenis Kendaraan*</label>
			<div class="col-md-9">
            ...
            <div class="col-md-9">
            <input type="text" id="no_kendaraan" name="no_kendaraan" placeholder="No. Kendaraan" class="form-control" minlength="1" maxlength="20">
            </div>
			</div>
            ...
            <div class="col-md-9">
            <input type="text" id="merk" name="merk" placeholder="Merk"  value="<?php echo $data1['merk']?>" class="form-control" minlength="1" maxlength="20" readonly>
           	</div>
			</div>

          	<div class="form-group">
 			<label class="col-md-3 control-label" for="thn_pembuatann">Tahun Pembuatan*</label>
            <div class="col-md-9">
            <input type="text" id="thn_pembuatann" name="thn_pembuatan" placeholder="Tahun Pembuatan" class="form-control" onkeypress="return hanyaAngka(event)" minlength="4" maxlength="4">
            </div>
          	</div>
            ...
            <div class="col-md-9">
            <input type="text" id="no_rangka" name="no_rangka" placeholder="No. Rangka" class="form-control" minlength="1" maxlength="20">
            </div>
         	</div>
            ...
            <div class="col-md-9">
            <input type="text" id="no_mesin" name="no_mesin" placeholder="No. Mesin"  class="form-control" minlength="1" maxlength="15">
            </div>
          	</div>
  ...
  <div class="form-group">
      <label class="col-md-3 control-label" for="posisi">Posisi*</label>
            <div class="col-md-9">
            <input type="text" id="posisi" name="posisi" placeholder="Posisi"   value="<?php echo $data1['posisi']?>"  class="form-control" minlength="1" maxlength="20" readonly>
            </div>
            </div>
            ...
            <option value="pilih" selected>-- Pilih Status Tersedia --</option>
      ...
      <label class="col-md-3 control-label" for="NIK">NIK*</label>
            <div class="col-md-9">
            <input type="text" id="NIK" name="NIK" placeholder="NIK"  value="<?php echo $_SESSION['nik']; ?>" class="form-control" readonly>
            </div>
            </div>
          ...
          <br>
            			 <div class="controls">
              <button class="btn btn-info  btn-md pull-right" name="simpan">Tambahkan</button>
            </div>
          </div>  
							</fieldset>
						</form>
