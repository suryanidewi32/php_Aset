...
<!--sidebar-->
       <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
            ...
            <li class="active"><a href="lappengembalian.php"><em class="fa   fa-rotate-right ">&nbsp;</em> Returns Report</a></li>
   ...
   <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
       ...
       <div class="panel panel-default chat">          
          ...
          <div class="nav-tabs-custom">
            ...
            $result=mysqli_query($connection, "SELECT tbpeminjaman.kodep,tbpeminjaman.NIK, tbuser.nama_user, daftarinventaris.kode_aset, tbaset.nama_aset, daftarinventaris.jns, daftarinventaris.merk, tbpeminjaman.jumlah_pesanan, tbpeminjaman.tgl_pengembalian
                FROM daftarinventaris
                INNER JOIN tbpeminjaman ON tbpeminjaman.kode_aset = daftarinventaris.kode_aset 
        ...
        ?>
            ...
            <tbody>
             ...
             $result=mysqli_query($connection, "SELECT tbpeminjaman.kodep,tbpeminjaman.NIK, tbuser.nama_user, tbkendaraan.kode_aset, tbaset.nama_aset, tbkendaraan.jns, tbkendaraan.merk, tbkendaraan.no_kendaraan, tbpeminjaman.jumlah_pesanan, tbpeminjaman.tgl_pengembalian
                FROM tbkendaraan
                INNER JOIN tbpeminjaman ON tbpeminjaman.kode_aset = tbkendaraan.kode_aset 
                INNER JOIN tbuser ON tbuser.NIK = tbpeminjaman.NIK
        ...
        ?>
           ...
           $result=mysqli_query($connection, "SELECT tbpeminjaman.kodep,tbpeminjaman.NIK, tbuser.nama_user, tbgedung.kode_aset, tbaset.kelompok_aset, tbaset.nama_aset, tbgedung.luas_gedung, tbpeminjaman.jumlah_pesanan, tbpeminjaman.tgl_pengembalian
                FROM tbgedung
                INNER JOIN tbpeminjaman ON tbpeminjaman.kode_aset = tbgedung.kode_aset 
                INNER JOIN tbuser ON tbuser.NIK = tbpeminjaman.NIK
