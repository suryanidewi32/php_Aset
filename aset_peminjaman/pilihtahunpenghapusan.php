            ...
            <li class="parent "><a data-toggle="collapse" href="#sub-item-2">
                ...
                <ul class="children collapse" id="sub-item-2">
                    <li><a class="" href="fixedasset.php">
                     ...
                     <li><a class="" href="datapenyusutan.php">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
  <a class="btn btn-default btn-sm" data-toggle="modal" data-target="#tampil"><i class=" fa fa-print"></i> Select Asset Deletion by Year</a>
   <?php
        include "modaltampilpenghapusan.php";
        ?>
...
<script type="text/javascript">
    ...
    function tampil(){
      ...
      var urlcetak = "/aset_peminjaman/cetakpdfpenghapusan.php?tgl_a="+tgl_a+"&tgl_b="+tgl_b;
